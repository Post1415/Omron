...
class SensorBeacon:
        ...
        if ((sensor_type_s == "IM") or (sensor_type_s == "EP")):
            ...
            if (sensor_type_s == "Rbt 0x01"):
                ...
                if (str_util.c2B(pkt[13]) == 0x00):
                    ...
                    self.vibinfo = 2 #VIBRATION
                elif (str_util.c2B(pkt[13]) == 0x02):
                    self.vibinfo = 3 #EARTHQUAKE
                else:
                    pass
            elif (sensor_type_s == "Rbt 0x03"):
                self.val_temp = str_util.bytes2short(
                    str_util.c2B(pkt[10]), str_util.c2B(pkt[9])) / 100.0
                self.val_humi = str_util.bytes2ushort(
                    str_util.c2B(pkt[12]), str_util.c2B(pkt[11])) / 100.0
    ...
    def debug_print(self):
        ...
        return str(self.val_temp), str(self.val_humi), str(self.val_light), str(self.val_uv), str(self.val_pressure), str(self.val_noise), str(self.val_di), str(self.val_heat), str(self.val_ax), str(self.val_ay), str(self.val_az), str(self.val_etvoc), str(self.val_eco2), str(self.val_si), str(self.val_pga), str(self.val_seismic), str(self.vibinfo), str(self.val_battery), str(self.rssi), str(self.distance), json.dumps(self.bt_address), json.dumps(self.sensor_type), self.flag_active
        
    def csv_format(self):
        str_data = str(self.gateway) + "," + \
                   str(self.bt_address) + "," + \
